...
function Register() {
    ...
    async function uploadImage() {
        ...
        return new Promise((resolve, reject) => {
            ...
            fileReader.onload = async () => {
                ...
                const GITHUB_TOKEN = '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';//Token de github, se elimina el 08/08
    ...
    async function onSubmitHandler(e) {
        ...
        let rutExist = await returnOracle("SELECT COALESCE(COUNT(*), 0) FROM CLIENTE WHERE RUT_CLI='" + rut + "'");
        let emailExist = await returnOracle("SELECT COALESCE(COUNT(*), 0) FROM CLIENTE WHERE CORREO_CLI='" + email + "'");
        if (rutExist != 0) {
    ...
    return (
        <section class="bg-gradient-to-r from-green-400 to-purple-600 pb-44 pt-11">
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 ">
                <Link to="/" href="#" name='Barritapatrahregisterusu' id='Barritapatraregisterusu' class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <SvgLogoUsado />
                </Link>
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div class="flex overflow-x-auto whitespace-nowrap">
                            <Link to="/Register" class="inline-flex items-center h-12 px-2 py-2 text-center text-gray-700 border border-b-0 border-gray-300 sm:px-4 dark:border-gray-500 rounded-t-md -px-1 dark:text-white whitespace-nowrap focus:outline-none">
