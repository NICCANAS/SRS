            ...
            <div id="services" class="section relative pt-40 pb-8 md:pt-16 md:pb-0 bg-white">
                <div class="container xl:max-w-6xl mx-auto px-4">
                    ...
                    <header class="text-center mx-auto mb-12 pt-12 lg:px-20">
                        <h2 class="text-2xl leading-normal mb-2 pt-30 font-bold text-black">Trabaja con nosotros</h2>
                        <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">Encuentra tu Proxima Practica laboral o como Empleado!</p>
                    </header>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4 text-center">
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp">
                            ...
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Espacios en Consultoria</h3>
                                <p class="text-gray-500">Hay 1+ Espacios disponibles</p>
                            </div>
                        ...
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp">
                            ...
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Creador de contenido</h3>
                                <p class="text-gray-500">Hay 1 Espacio disponibles para creador de contenido</p>
                            </div>
                        ...
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp">
                            ...
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Buscador</h3>
                                <p class="text-gray-500">Hay 1+ Espacio disponibles para creador de Buscador</p>
                            </div>
                        ...
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp">
                            ...
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Verificador </h3>
                                <p class="text-gray-500">Hay 1+ Espacio disponibles de Verificador</p>
                            </div>
                        ...
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Marketing</h3>
                                <p class="text-gray-500">Hay 1+ Espacio disponibles para Marketing</p>
                            </div>
                        ...
                        <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                            ...
                            <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                                ...
                                <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Programador</h3>
                                <p class="text-gray-500">hay 1+ Espacio disponibles para Programador</p>
                            </div>
