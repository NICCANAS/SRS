        ...
        <>
            ...
            <div class="flex min-h-screen items-center justify-start bg-white">
                <div class="mx-auto w-full max-w-lg">
                    <h1 class="text-4xl font-medium">Contactate con nosotros</h1>
                    <p class="mt-3">Envianos tu opinión o recomendaciones.</p>
                    ...
                    <form action="https://api.web3forms.com/submit" class="mt-10">
                        ...
                        <button type="submit" class="mt-5 rounded-md bg-black px-10 py-2 text-white">Enviar mensaje</button>
                    </form>
                </div>
            </div></>
