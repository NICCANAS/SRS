...
function ListServs() {
    ...
    return (
        <div className="flex flex-wrap bg-gray-100 w-full h-screen">
            <div className='bg-white w-3/12 rounded p-3'  >
                <div className="flex items-center space-x-4 p-2 mb-5">
                    <img className="h-12 rounded-full" alt='fotousu' src="https://avatars.githubusercontent.com/u/101841361?s=400&u=0c98e9da99e7f8e1d0d9c954d43d7c02470112bf&v=4" />
                    <div>
                        <h4 className="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">Nikolai</h4>
